...
var step = function step(dom, index, parent, getTag) {
  ...
  if (dom.type === 'tag' || dom.type === 'script' || dom.type === 'style') {
    ...
    if (_selfClosingElements2.default.indexOf(dom.name) !== -1) {
      return _react2.default.createElement(Component, _extends({ 'data-tag': dom.name, key: index }, dom.attribs));
    }
    var isParentBlock = parent && _inlineElements2.default.indexOf(parent.name) === -1;
    var _children = isParentBlock ? (0, _groupInlineElements2.default)(dom.children) : dom.children;
    return _react2.default.createElement(
      Component,
      _extends({
        key: index,
        'data-tag': dom.name
      }, (0, _mapAttributes2.default)(dom.attribs)),
