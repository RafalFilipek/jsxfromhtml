...
var createGetTagFunction = function createGetTagFunction() {
  var mapElements = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var mapInline = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var mapBlock = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
